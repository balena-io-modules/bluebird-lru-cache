...
(function() {
  var BluebirdLRU, LRUCache, Promise,
  ...
  module.exports = BluebirdLRU = (function(_super) {
    var NoSuchKeyError, method, rejectCheck, rejectedGet, rejectedPeek, _fn, _i, _len, _ref;

    __extends(BluebirdLRU, _super);

    _ref = ['set', 'get', 'peek', 'del', 'reset', 'has', 'keys', 'values'];
    _fn = function() {
    ...
    BluebirdLRU.NoSuchKeyError = NoSuchKeyError = (function(_super1) {
      __extends(NoSuchKeyError, _super1);

      function NoSuchKeyError(key) {
        this.key = key;
